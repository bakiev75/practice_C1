...
class LinkedList:                                   # класс списка
    ...
    def pushleft(self, value):                      # Метод добавления элемента в НАЧАЛО списка
    ...
    def pushright(self, value):                     # Метод добавления элемента в КОНЦЕ списка
        if self.first is None:
            self.first = Node(value)
            self.last = self.first
        else:
    ...
    def popleft(self):                              # Удаление (вывод из списка) ПЕРВОГО элемента
    ...
    def popright(self):                             # Удаление последнего элемента
        if self.first is None:                      # если список пустой, возвращаем None
            return None
        elif self.first == self.last:               # если список содержит только один элемент
            node = self.first                       # сохраняем его
